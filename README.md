<img src="https://ik.imagekit.io/g39hqj8mc/logo_1__bJtQz4Zyp.png?ik-sdk-version=javascript-1.4.3&updatedAt=1666396394021" width=340px />
...
2. Setup the backend code -
   ...
   - Clone the code & install the modules-
     ...
     ```
     git clone https://github.com/nickmazurenko/usof
     cd ./usof/backend
...
3. Open a new CLI terminal and goto the root `backend` folder you created in the first step.
